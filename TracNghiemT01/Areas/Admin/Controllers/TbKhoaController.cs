...
namespace TracNghiemT01.Areas.Admin.Controllers
{
    ...
    public class TbKhoaController : Controller
    {
        ...
        // GET: Admin/TbKhoa/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/TbKhoa/Create
